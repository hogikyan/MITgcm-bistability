...
C
     ...
     &        recip_hFacC(i,j,k,bi,bj) = oneRS / hFacC(i,j,k,bi,bj)
            IF ( maskW(i,j,k,bi,bj).NE.zeroRS )
     &        recip_hFacW(i,j,k,bi,bj) = oneRS / hFacW(i,j,k,bi,bj)
            IF ( maskS(i,j,k,bi,bj).NE.zeroRS )
     &        recip_hFacS(i,j,k,bi,bj) = oneRS / hFacS(i,j,k,bi,bj)
          ENDDO
         ENDDO
        ENDDO
...
c     CALL EXCH_XYZ_RS (  hFacC,  myThid  )
c     CALL EXCH_XYZ_RS (  recip_hFacC,  myThid  )
